...
% Parameters for interpolation
  ...
  [d_interp1] = spitz_fx_interpolation(d,dt,npf,pre1,pre2,flow,fhigh);

% Figures - first with wiggles

  figure(1);
  subplot(121); wigb(d,2,h,taxis); title('Original');
  subplot(122); wigb(d_interp1,2,h_interp,taxis); title('After Spitz FX Interpolation');
